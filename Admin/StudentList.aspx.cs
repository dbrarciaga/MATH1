        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection cons = new MySqlConnection(waow))
            {
                try
                {
                    ...
                    MySqlCommand utos = new MySqlCommand("Select stud_id as 'ID', concat(FirstName,' ',LastName) as 'Name', username from teacher where stud_id = '" + TextBox1.Text + "' or username = '" + TextBox1.Text + "'  ", cons);
                    MySqlDataReader myRead = utos.ExecuteReader();
