<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="C#" MasterPageFile="~/Story/Site1.Master" AutoEventWireup="true" CodeBehind="Subtraction.aspx.cs" Inherits="MATH1.Story.WebForm2" %>
  ...
  * {
  ...
  .step.finish {
    ...
    <section >
        ...
        <h1 style="font-size:250%" class="fonts">Chapter 2 </h1>
        <h4 style="font-size:150%" class="fonts"><asp:label runat="server" ID="title1" Text=""></asp:label></h4>
        <h5 tyle="font-size:150%" class="fonts"> The process of taking away a number from another</h5>
    ...
    <div>
        <h3 class="second fonts w3-container" style="margin-bottom:25px; font-size:500%; text-align:center;">Subtraction of Numbers</h3>
        ...
        <div class="w3-row w3-border w3-white w3-mobile" >
            ...
            <div class="w3-container w3-half">
               <p style="font-family:'Comic Sans MS'; text-align:center;font-size:45px;"><b>How?</b></p>
                <p style="font-family:'Copperplate Gothic'; text-align:center;font-size:30px;">
                    First we Put the bigger number on top of the smaller number. Then Stack the numbers so the digits are in columns according to their place value. After that we Regroup when needed. Subtract starting with the column on the right and go left.
                </p>
                <p><center>
                   <audio controls>
                   <source src="https://feeds.soundcloud.com/stream/1636791219-rencee-c-banez-sub-how.mp3" type="audio/mpeg" />
                   </audio>
                    </center>
                    </p>
           </div> 
           ...
           <div class="w3-container w3-half w3-mobile">    
               <a><img  style="height:100%; width:100%;" src="https://i.imgur.com/rB7b951.gif" title="source: imgur.com" /></a>      
          </div>
