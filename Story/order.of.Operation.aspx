<%@ Page  MaintainScrollPositionOnPostback="true" Title="" Language="C#" MasterPageFile="~/Story/Site1.Master" AutoEventWireup="true" CodeBehind="order.of.Operation.aspx.cs" Inherits="MATH1.Story.WebForm9" %>
  ...
  * {
  ...
  .step.finish {
    ...
    <section >
        ...
        <h1 style="font-size:250%" class="fonts">Chapter 9 </h1>
    ...
    <section class="secBlack">
        <h3 class="second fonts w3-container" style="margin-bottom:25px; font-size:500%; text-align:center;">Order of Operation</h3>
        ...
        <div class="w3-row w3-border w3-white w3-mobile" >
            ...
            <div class="w3-container w3-half">
               ...
               <p style="font-family:'Comic Sans MS'; text-align:center;font-size:30px;">
                    The order of operation is the rule that tell us the sequence in which we should solve an expression with multiple operations. The order is <b>PEMDAS</b>: Parentheses, Exponents, Multiplication, and Division (from left to right), Addition and Subtraction (from left to right).
                </p>
                  <p><center>
                   <audio controls>
                   <source src="../voice/order_how.mp3" type="audio/mpeg" />
                   </audio>
                </center></p>
           ...
           <div class="w3-container w3-half w3-mobile">    
                 <a><img src="https://i.imgur.com/DTsTTSb.gif" title="source: imgur.com" /></a>
          </div>
        </div>     
    </section>
    <!--HOW-->
