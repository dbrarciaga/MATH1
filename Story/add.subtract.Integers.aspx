<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="C#" MasterPageFile="~/Story/Site1.Master" AutoEventWireup="true" CodeBehind="add.subtract.Integers.aspx.cs" Inherits="MATH1.Story.WebForm5" %>
  ...
  * {
  ...
  .step.finish {
    ...
    <section >
        ...
        <h1 style="font-size:250%" class="fonts">Chapter 5 </h1>
        <h4 style="font-size:150%" class="fonts"><asp:label runat="server" ID="title1" Text=""></asp:label></h4>
        <h5 tyle="font-size:150%" class="fonts">Addition and Subtraction of Integers</h5>
    </div>
    </section>
    <!--1st-->
    ...
    <section class="secBlack">
           <h3 class="second fonts w3-container" style="margin-bottom:25px; font-size:400% ">Addition and Subtraction of Integers</h3>
        ...
        <div class="w3-row w3-border w3-white w3-mobile" >
            ...
            <div class="w3-container w3-half">
               ...
               <p style="font-family:'Comic Sans MS'; text-align:center;font-size:30px;">
                     There are Rules to follow in Adding and Subtracting Integers;
                     Adding two positive integers will result in positive integer, 
                     whereas adding two negative integers will result with a negative integer.
                     But the addition of two different signed integers will result in 
                     subtraction and the sign of the result will be the same as the sign of the 
                     larger integer.
                </p>
                  <p><center>
                   <audio controls>
                   <source src="../voice/asint_how.mp3" type="audio/mpeg" />
                   </audio>
                </center></p>
           ...
           <div class="w3-container w3-half w3-mobile">    
                <a><img src="https://i.imgur.com/8EJstKR.gif" title="source: imgur.com" /></a>
          </div>
        </div>     
    </section>
    <!--HOW-->
