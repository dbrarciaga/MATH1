<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="C#" MasterPageFile="~/Story/Site1.Master" AutoEventWireup="true" CodeBehind="Exponents.aspx.cs" Inherits="MATH1.Story.WebForm8" %>
  ...
  * {
  ...
  .step.finish {
    ...
    <section >
        ...
        <h1 style="font-size:250%" class="fonts">Chapter 8 </h1>
    ...
    <section class="secBlack">
        <h3 class="second fonts w3-container" style="margin-bottom:25px; font-size:500%; text-align:center;">Exponents</h3>
        ...
        <div class="w3-row w3-border w3-white w3-mobile" >
            ...
            <div class="w3-container w3-half">
               ...
               <p style="font-family:'Comic Sans MS'; text-align:center;font-size:30px;">
                      Exponents are used to express repeated multiplication of a number.  The exponent tells us how many times the base is multiplied by itself.
                </p>
                  <p><center>
                   <audio controls>
                   <source src="../voice/ex_how.mp3" type="audio/mpeg" />
                   </audio>
                </center></p>
           ...
           <div class="w3-container w3-half w3-mobile">    
                 <a><img src="https://i.imgur.com/Tzbhwor.gif" title="source: imgur.com" /></a>
          </div>
        </div>     
    </section>
    <!--HOW-->
