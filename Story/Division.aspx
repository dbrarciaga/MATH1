<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="C#" MasterPageFile="~/Story/Site1.Master" AutoEventWireup="true" CodeBehind="Division.aspx.cs" Inherits="MATH1.Story.WebForm4" %>
  ...
  * {
  ...
  .step.finish {
    ...
    <section >
        ...
        <h1 style="font-size:250%" class="fonts">Chapter 4 </h1>
        <h4 style="font-size:150%" class="fonts"><asp:label runat="server" ID="title1" Text=""></asp:label></h4>
        <h5 tyle="font-size:150%" class="fonts">process of breaking a number up into equal parts</h5>
    ...
    <section class="secBlack">
        <h3 class="second fonts w3-container" style="margin-bottom:25px; font-size:500%; text-align:center;">Division of Whole Numbers</h3>
        ...
        <div class="w3-row w3-border w3-white w3-mobile" >
            ...
            <div class="w3-container w3-half">
               ...
               <p style="font-family:'Comic Sans MS'; text-align:center;font-size:30px;">
                     There are Two Methods in Dividing Whole Numbers;
                    <br />
                     First is <b>Repeated Subtraction</b>. Count have many time you can subtract 
                    the Divisor with the Dividend until you get to 0.
                </p>
                  <p><center>
                   <audio controls>
                   <source src="https://feeds.soundcloud.com/stream/1637330793-rencee-c-banez-div-how1.mp3" type="audio/mpeg" />
                   </audio>
                </center></p>
           ...
           <div class="w3-container w3-half w3-mobile">    
               <a><img src="https://i.imgur.com/ryRClui.gif" title="source: imgur.com" /></a>   
          </div>
        </div>     
    </section>
    <!--HOW-->
    ...
    <section class="secBlack">
        ...
        <div class="w3-row w3-border w3-white w3-mobile" >
            ...
            <div class="w3-container w3-half">
               <p style="font-family:'Comic Sans MS'; text-align:center;font-size:45px;"><b>How?</b></p>
               <p style="font-family:'Comic Sans MS';font-size:30px;">
                     <b>Step 1:</b> Take the first digit of the dividend from the left. Check if 
                      <br />
                    this digit is greater than or equal to the divisor.
                      <br />
                   <b>Step 2:</b> Then divide it by the divisor and write the answer on top of 
                    the quotient.
                      <br />
                   <b>Step 3:</b> Subtract the result from the digit and write the difference 
                    below.
                      <br />
                   <b>Step 4:</b> Bring down the next digit of the dividend (if present).
                      <br />
                   <b>Step 5:</b> Repeat the same process until you get to zero
                </p>
                  <p><center>
                   <audio controls>
                   <source src="https://feeds.soundcloud.com/stream/1637331126-rencee-c-banez-div-how2.mp3" type="audio/mpeg" />
                   </audio>
                </center></p>
           ...
           <div class="w3-container w3-half w3-mobile"> 
               ...
               <br />
               <br />
               <a><img src="https://i.imgur.com/BUzJFKN.gif" title="source: imgur.com" /></a> 
          </div>
        </div>     
    </section>
    <!--HOW2-->
