...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:1000px" class="w3-card w3-white w3-margin">
        <center><h1 style="font-family:'Gill Sans MT'; font-size:80px; text-decoration:underline">Select Quiz</h1></center>
        <br />
        <br />
        <br />
        <br />
       ...
       <center>
            ...
            <div class="w3-third">
              ...
              <b style="font-family:'Gill Sans MT'; font-size:25px;"> <asp:Button ID="select" runat="server" Text="select" CssClass="w3-button w3-deep-purple w3-round-xlarge" Height="120px" Width="50%" OnClick="select_Click" /></b> 
            </div>
            <div class="w3-third">
